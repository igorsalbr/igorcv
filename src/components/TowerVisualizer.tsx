...
export function TowerVisualizer({ towerHeight, onResetTower }: TowerVisualizerProps) {
  ...
  return (
    <div className="relative w-20 border border-gray-500 items-center " style={{ height: "auto" }}>
      {/* The actual tower */}
      <div className="transition-all duration-300 bg-[#1f1]" style={{ height: `${currentHeight}vh` }} />
