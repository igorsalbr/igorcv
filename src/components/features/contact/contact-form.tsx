      ...
      <CardContent className="p-0">
        ...
        <div className="flex flex-col items-center justify-center gap-4 p-6 sm:p-8">
          <div className="w-full text-left">
            <Label htmlFor="message" className="block mb-2 font-bold text-sm text-gray-700 dark:text-gray-300">
              Send me a message:
            </Label>
            <Textarea
              id="message"
          ...
          >
            <Button
              ...
              disabled={!isAuthenticated || status === "loading" || message.trim() === ""}
            >
              {!isAuthenticated ? (
          ...
          {!isAuthenticated && (
            <Link href="/login" className="text-brand-primary hover:text-brand-primary/80 text-sm">
              Click here to Login
            </Link>
          )}
        </div>
